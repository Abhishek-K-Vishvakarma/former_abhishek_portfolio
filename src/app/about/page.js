    ...
    ===================== */}
      ...
      "
            ...
            <p className="text-slate-400 text-sm sm:text-base md:text-lg leading-7 sm:leading-8 mt-6 sm:mt-8 max-w-3xl mx-auto">
              ...
              , a Full Stack Developer and AI/ML Engineer focused on scalable
              backend systems, AI integrations, cloud deployment, Docker
              infrastructure, and modern frontend experiences.
            </p>
          </div>
                ...
                <div className="relative rounded-[27px] sm:rounded-[39px] bg-[#050e1a] p-3 sm:p-5 overflow-hidden">
                  ...
                  <div className="relative z-10 flex items-center justify-between px-2 mb-3 sm:mb-4">
                    ...
                    <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-green-500/10 border border-green-500/20">
                      ...
                      <span className="text-[8px] sm:text-[9px] text-green-400 font-bold tracking-wider">
                        AVAILABLE
                      </span>
                    </div>
                  </div>
        ...
        "
              >
                ...
                <p className="text-slate-400 text-sm sm:text-base leading-7 sm:leading-8 mt-4 sm:mt-5">
                  I love solving real-world problems using modern technologies.
                  Every project I build is crafted with performance,
                ...
                <p className="text-slate-400 text-sm sm:text-base leading-7 sm:leading-8 mt-3 sm:mt-4">
                  My expertise includes MERN Stack, FastAPI, Docker, cloud
                  deployment, and building intelligent AI-powered applications
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  ...
                  },
                  {
                    icon: '🤖',
                    label: 'AI Focused',
                    desc: 'LLM & ML integrations',
                  },
                  {
                    icon: '☁️',
                    label: 'Cloud Ready',
                    desc: 'Docker & AWS deploy',
                  },
                ].map((item, i) => (
                  <div
                    key={i}
